...
paths, and the scenario references throughout, all in one pass. Two things stand
out immediately, both confirmed by actually running the command rather than
reading about it:
