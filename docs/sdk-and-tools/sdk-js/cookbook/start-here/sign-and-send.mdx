...
cd cookbook/recipes/sign-and-send
npm install
npm run dev
...
It is tempting to assume `useGetPendingTransactions()` accepts the `sessionId`
...
`node_modules/@multiversx/sdk-dapp/out/react/transactions/useGetPendingTransactions.d.ts`
on `@multiversx/sdk-dapp@5.6.23`. It returns *every* pending transaction across
