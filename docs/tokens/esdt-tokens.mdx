...
It is also possible to send ESDT tokens to a contract as part of a method call.
...
MultiTokensTransferTransaction {
    ...
    Data: "MultiESDTNFTTransfer" +
          ...
          "@" + <optionally, the name of a method to call in hexadecimal encoding> +
          "@" + <optionally, the first argument of the method in hexadecimal encoding> +
          "@" + <optionally, the second argument of the method in hexadecimal encoding> +
          ...
}
```
