...
The version reported by this command must be at least `erdpy 0.7.0`, or higher. If `erdpy` is not installed (`command not found`), or if the version is lower than `0.7.0`, please follow [these instructions](https://docs.elrond.com/tools/erdpy/installing-erdpy).
