      ...
      <li>
        ...
        >
          <div className="grow shrink basis-0 self-stretch rounded-2xl flex-col justify-between items-start inline-flex">
            ...
            <p className="ms-0 mb-0 self-stretch text-neutral-500 text-sm leading-tight">
              {text}
            </p>
          </div>
        </Link>
        ...
        <div className="grow shrink basis-0 self-stretch rounded-2xl flex-col justify-between items-start inline-flex">
          <div className="self-stretch h-[65px] flex-col justify-start items-start gap-3 flex">
            ...
            <div className="self-stretch justify-start items-center gap-1 inline-flex">
              <div className="text-primary text-[21px] font-semibold leading-[21px]">
                {title}
              </div>
              <div className="w-4 h-4 justify-center items-center flex">
                <FontAwesomeIcon
          ...
          <p className="ms-0 mb-0 text-neutral-500 leading-snug">{text}</p>
        </div>
      </Link>
    </li>
  );
