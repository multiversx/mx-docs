...
See also: Layer 1, Shard (Execution Shard), Consensus, Secure Proof of Stake.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Blockchain, Adaptive State Sharding, Sovereign Chains.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding).
...
See also: Round, Shard (Execution Shard), Metachain, Finality.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Account Nonce, Gas and Fees, Built-in Functions, Onchain Guardian.
Source: [docs.multiversx.com/developers/transactions/tx-overview](https://docs.multiversx.com/developers/transactions/tx-overview/); [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core).
...
See also: Bech32 Addressing, Account Nonce, Smart Contract, Account State Trie.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/developers/account-management](https://docs.multiversx.com/developers/account-management/).
...
See also: WASM VM, multiversx-sc (mx-sdk-rs), Account, Tx Syntax.
Source: [docs.multiversx.com/developers/overview](https://docs.multiversx.com/developers/overview/).
...
See also: Secure Proof of Stake, Consensus Group, Equivalent Consensus Proof, Finality.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Secure Proof of Stake, Staking, Validator (node), Byzantine Fault Tolerance.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Secure Proof of Stake, Consensus, Equivalent Consensus Proof.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Deterministic Finality, Equivalent Consensus Proof, Block Time, Supernova.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Finality, Equivalent Consensus Proof, Supernova, Byzantine Fault Tolerance.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Round, Finality, Supernova.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus); MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)).
...
See also: Transaction, Shard (Execution Shard), Supernova.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding).
...
See also: Block, Verifiable Random Function, Account State Trie.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Account, Adaptive State Sharding, Hash.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding).
...
See also: Gas and Fees, Transaction, Smart Contract Results.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Block, Cross-Shard Transaction, Metablock, Cross-Shard Atomicity.
Source: [docs.multiversx.com/learn/transactions](https://docs.multiversx.com/learn/transactions).
...
See also: Metachain, Notarization, Miniblock, Hyperblock.
Source: [docs.multiversx.com/learn/transactions](https://docs.multiversx.com/learn/transactions).
...
See also: Round, Epoch, Block.
Source: [docs.multiversx.com/learn/chronology](https://docs.multiversx.com/learn/chronology).
...
See also: Cross-Shard Transaction, Shard (Execution Shard), Bech32 Addressing.
Source: [docs.multiversx.com/integrators/faq](https://docs.multiversx.com/integrators/faq/); [docs.multiversx.com/learn/transactions](https://docs.multiversx.com/learn/transactions).
...
See also: Intra-Shard Transaction, Cross-Shard Atomicity, Miniblock, Metachain.
Source: [docs.multiversx.com/integrators/faq](https://docs.multiversx.com/integrators/faq/); [docs.multiversx.com/learn/transactions](https://docs.multiversx.com/learn/transactions).
...
See also: Verifiable Random Function (VRF), Block Proposer (Leader), Secure Proof of Stake (SPoS).
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Testnet, Devnet, EGLD, Shard (Execution Shard).
Source: [docs.multiversx.com/learn/EGLD](https://docs.multiversx.com/learn/EGLD/).
...
See also: Devnet, Mainnet, Faucet, Chain Simulator.
Source: [docs.multiversx.com/learn/EGLD](https://docs.multiversx.com/learn/EGLD/).
...
See also: Testnet, Mainnet, Faucet, Chain Simulator.
Source: [docs.multiversx.com/learn/EGLD](https://docs.multiversx.com/learn/EGLD/).
...
See also: Testnet, Devnet, Web Wallet, EGLD.
Source: [docs.multiversx.com/wallet/web-wallet](https://docs.multiversx.com/wallet/web-wallet/); [docs.multiversx.com/learn/EGLD](https://docs.multiversx.com/learn/EGLD/).
...
See also: Metachain, Hyperblock, Cross-Shard Atomicity, Secure Proof of Stake.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding); founding whitepaper, *A Highly Scalable Public Blockchain via Adaptive State Sharding and Secure Proof of Stake* ([files.multiversx.com/multiversx-whitepaper.pdf](https://files.multiversx.com/multiversx-whitepaper.pdf)).
...
See also: Hyperblock, Cross-Shard Atomicity, Validator Reshuffle, Secure Proof of Stake.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/integrators/faq](https://docs.multiversx.com/integrators/faq/).
...
See also: Metachain, Cross-Shard Atomicity, Supernova.
Source: [docs.multiversx.com/integrators/querying-the-blockchain](https://docs.multiversx.com/integrators/querying-the-blockchain/); [docs.multiversx.com/sdk-and-tools/rest-api/blocks](https://docs.multiversx.com/sdk-and-tools/rest-api/blocks/).
...
See also: Metachain, Hyperblock, Supernova, Typed Proxies.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding); [github.com/multiversx/mx-chain-go](https://github.com/multiversx/mx-chain-go).
...
See also: Adaptive State Sharding, Validator Reshuffle, Metachain.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus); founding whitepaper ([files.multiversx.com/multiversx-whitepaper.pdf](https://files.multiversx.com/multiversx-whitepaper.pdf)).
...
See also: Secure Proof of Stake, Metachain, Adaptive State Sharding.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding) (node shuffling); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/) (validator definition).
...
See also: Relayed Transactions, NativeAuth.
Source: [docs.multiversx.com/developers/built-in-functions](https://docs.multiversx.com/developers/built-in-functions/); The Block, "MultiversX introduces on-chain 2FA" (July 14, 2023, [theblock.co/post/239592/multiversx-on-chain-2fa](https://www.theblock.co/post/239592/multiversx-on-chain-2fa)).
...
See also: Spica, Onchain Guardian.
Source: [docs.multiversx.com/developers/relayed-transactions](https://docs.multiversx.com/developers/relayed-transactions/); MultiversX SDK reference ([github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core)).
...
See also: ESDT, sc-meta, Storage Mappers, Tx Syntax.
Source: [docs.multiversx.com/learn/space-vm](https://docs.multiversx.com/learn/space-vm); [github.com/multiversx/mx-chain-vm-go](https://github.com/multiversx/mx-chain-vm-go).
...
See also: WASM VM, EGLD, Bech32 Addressing.
Source: [docs.multiversx.com/tokens/intro](https://docs.multiversx.com/tokens/intro) (expansion and protocol-level handling); [docs.multiversx.com/tokens/esdt-tokens](https://docs.multiversx.com/tokens/esdt-tokens/).
...
See also: ESDT, Adaptive State Sharding, EGLD.
Source: [docs.multiversx.com/technology/glossary](https://docs.multiversx.com/welcome/terminology/); MultiversX SDK `Address` reference ([github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core)).
...
See also: Economic Evolution, Staking V5, EGLD, Governance Proposal Process.
Source: "A competitive economic framework for MultiversX: toward revenue and reflexive value accrual," MultiversX Agora ([agora.multiversx.com/t/...530](https://agora.multiversx.com/t/a-competitive-economic-framework-for-multiversx-toward-revenue-and-reflexive-value-accrual/530)); MultiversX, "The MultiversX Economic Evolution" (Oct 22, 2025, [multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion](https://multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion)).
...
See also: Adaptive State Sharding, Metachain, Cross-Shard Atomicity, Bech32 Addressing.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Adaptive State Sharding, Shard (Execution Shard), Metachain, Validator Reshuffle.
Source: [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding); founding whitepaper ([files.multiversx.com/multiversx-whitepaper.pdf](https://files.multiversx.com/multiversx-whitepaper.pdf)).
...
See also: Round, Validator Reshuffle, Unbonding Period, Onchain Guardian.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/staking](https://docs.multiversx.com/validators/staking/).
...
See also: Epoch, Secure Proof of Stake, Supernova.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Cross-Shard Atomicity, Built-in Functions, Gas and Fees.
Source: [docs.multiversx.com/developers/developer-reference/sc-api-functions](https://docs.multiversx.com/developers/developer-reference/sc-api-functions/).
...
See also: ESDT, System Smart Contracts, Onchain Guardian, Herotag.
Source: [docs.multiversx.com/developers/built-in-functions](https://docs.multiversx.com/developers/built-in-functions/).
...
See also: ESDT, Staking, Delegation, Governance Proposal Process.
Source: [docs.multiversx.com/validators/staking/staking-smart-contract](https://docs.multiversx.com/validators/staking/staking-smart-contract/); [docs.multiversx.com/developers/built-in-functions](https://docs.multiversx.com/developers/built-in-functions/).
...
See also: Developer Revenue Share, Smart Contract Results, Relayed Transactions.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Gas and Fees, Gas-Price Modifier, Smart Contract Results.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Gas and Fees, Move Balance, Gas Refund, Developer Revenue Share.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Bech32 Addressing, Built-in Functions.
...
See also: Adaptive State Sharding, ESDT.
Source: [docs.multiversx.com/sovereign/overview](https://docs.multiversx.com/sovereign/overview/); [docs.multiversx.com/sovereign/concept](https://docs.multiversx.com/sovereign/concept/).
...
See also: WASM VM (and Wasmer), Stateless Execution, Smart Contract.
Source: [docs.multiversx.com/learn/space-vm](https://docs.multiversx.com/learn/space-vm).
...
See also: SpaceVM, WASM VM (and Wasmer), Smart Contract Results (SCRs).
Source: [docs.multiversx.com/learn/space-vm](https://docs.multiversx.com/learn/space-vm).
...
See also: Sovereign Chains, Dual Staking (Sovereign Chains), Staking, Delegation.
Source: [docs.multiversx.com/sovereign/restaking](https://docs.multiversx.com/sovereign/restaking/).
...
See also: Sovereign Chains, Restaking (Sovereign Chains), Staking.
Source: [docs.multiversx.com/sovereign/dual-staking](https://docs.multiversx.com/sovereign/dual-staking/).
...
See also: Sovereign Chains, ESDT-Safe, Cross-Shard Message Buffer.
Source: [docs.multiversx.com/sovereign/concept](https://docs.multiversx.com/sovereign/concept/).
...
See also: Sovereign Chains, Header Verifier, Ad-Astra Bridge, Bridged Tokens.
Source: [docs.multiversx.com/sovereign/concept](https://docs.multiversx.com/sovereign/concept/).
...
See also: Bridged Tokens, Axelar (Bridge), ESDT-Safe, WEGLD (Wrapped EGLD).
Source: [docs.multiversx.com/bridge/architecture](https://docs.multiversx.com/bridge/architecture/).
...
See also: Ad-Astra Bridge, Bridged Tokens, Observing Squad.
Source: [docs.multiversx.com/bridge/axelar](https://docs.multiversx.com/bridge/axelar/).
...
See also: Ad-Astra Bridge, Axelar (Bridge), ESDT (eStandard Digital Token), WEGLD (Wrapped EGLD).
Source: [docs.multiversx.com/bridge/token-types](https://docs.multiversx.com/bridge/token-types/).
...
See also: Secure Proof of Stake, Block Proposer, Validator Reshuffle, Equivalent Consensus Proof.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Consensus Group, Verifiable Random Function, BLS Multi-Signature, Equivalent Consensus Proof.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Block Proposer, Secure Proof of Stake, Validator Reshuffle.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: Equivalent Consensus Proof, Consensus Group, Secure Proof of Stake.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus).
...
See also: BLS Multi-Signature, Deterministic Finality, Andromeda, Notarization.
Source: [docs.multiversx.com/learn/consensus](https://docs.multiversx.com/learn/consensus); [docs.multiversx.com/integrators/faq](https://docs.multiversx.com/integrators/faq/).
...
See also: Metachain, Hyperblock, Cross-Shard Atomicity, Equivalent Consensus Proof.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/integrators/faq](https://docs.multiversx.com/integrators/faq/).
...
See also: Pipelined Consensus, Partial-Precommit Execution Dispatch, Supernova, Deterministic Finality.
Source: MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)).
...
See also: Agree-then-Run, Partial-Precommit Execution Dispatch, Supernova.
Source: MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)).
...
See also: Pipelined Consensus, Cross-Shard Message Buffer, Cross-Shard Atomicity, Supernova.
Source: MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)).
...
See also: Cross-Shard Atomicity, Partial-Precommit Execution Dispatch, Metachain, Supernova.
Source: MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)).
...
See also: ESDT, ESDT Roles, Dynamic NFTs.
Source: [docs.multiversx.com/tokens/nft-tokens](https://docs.multiversx.com/tokens/nft-tokens/).
...
See also: ESDT, ESDT Roles, Spica.
Source: [docs.multiversx.com/tokens/nft-tokens](https://docs.multiversx.com/tokens/nft-tokens/).
...
See also: ESDT, Meta-ESDT, Dynamic NFTs.
Source: [docs.multiversx.com/tokens/nft-tokens](https://docs.multiversx.com/tokens/nft-tokens/).
...
See also: ESDT, Token Identifier, NFT.
Source: [docs.multiversx.com/tokens/intro](https://docs.multiversx.com/tokens/intro).
...
See also: ESDT, SFT, Dynamic NFTs, NFT Royalties.
Source: [docs.multiversx.com/tokens/nft-tokens](https://docs.multiversx.com/tokens/nft-tokens/).
...
See also: ESDT, NFT, Meta-ESDT, ESDT Roles.
Source: [docs.multiversx.com/tokens/nft-tokens](https://docs.multiversx.com/tokens/nft-tokens/).
...
See also: ESDT, Fungible Token, NFT.
Source: [docs.multiversx.com/tokens/esdt-tokens](https://docs.multiversx.com/tokens/esdt-tokens/).
...
See also: Staking, Delegation, ESDT.
Source: [github.com/multiversx/mx-liquid-staking-sc](https://github.com/multiversx/mx-liquid-staking-sc).
...
See also: EGLD, ESDT, Fungible Token, Liquid Staking.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`contracts/core/wegld-swap`); [docs.multiversx.com/tokens/intro](https://docs.multiversx.com/tokens/intro).
...
See also: ESDT (eStandard Digital Token), ESDT Roles (Special Roles), Freeze and Wipe, Pause (Token), Local Mint and Burn.
Source: [docs.multiversx.com/tokens/fungible-tokens](https://docs.multiversx.com/tokens/fungible-tokens/).
...
See also: ESDT (eStandard Digital Token), Token Properties (canFreeze, canWipe, canPause, ...), Pause (Token), ESDT Roles (Special Roles).
Source: [docs.multiversx.com/tokens/fungible-tokens](https://docs.multiversx.com/tokens/fungible-tokens/).
...
See also: ESDT (eStandard Digital Token), Token Properties (canFreeze, canWipe, canPause, ...), Freeze and Wipe.
Source: [docs.multiversx.com/tokens/fungible-tokens](https://docs.multiversx.com/tokens/fungible-tokens/).
...
See also: ESDT (eStandard Digital Token), ESDT Roles (Special Roles), Token Properties (canFreeze, canWipe, canPause, ...).
Source: [docs.multiversx.com/tokens/fungible-tokens](https://docs.multiversx.com/tokens/fungible-tokens/).
...
See also: Validator, Observer, Observing Squad.
...
See also: Observer, Secure Proof of Stake, Validator Rating, Jailing, Staking.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/overview](https://docs.multiversx.com/validators/overview/).
...
See also: Node, Validator, Observing Squad.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/overview](https://docs.multiversx.com/validators/overview/).
...
See also: Observer, Shard (Execution Shard), Metachain.
Source: [docs.multiversx.com/integrators/observing-squad](https://docs.multiversx.com/integrators/observing-squad/).
...
See also: Validator, Jailing, Secure Proof of Stake.
Source: [docs.multiversx.com/validators/rating](https://docs.multiversx.com/validators/rating/).
...
See also: Validator Rating, Validator, Staking.
Source: [docs.multiversx.com/validators/rating](https://docs.multiversx.com/validators/rating/).
...
See also: Validator, Delegation, Staking Auction and TopUp, Unbonding Period.
Source: [docs.multiversx.com/validators/staking](https://docs.multiversx.com/validators/staking/); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Staking, System Smart Contracts, Staking Auction and TopUp.
Source: [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Staking, Staking V5, Validator.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/).
...
See also: Staking, Delegation, Epoch.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/staking](https://docs.multiversx.com/validators/staking/).
...
See also: Unstake, Unbonding Period, Staking, Delegation.
Source: [docs.multiversx.com/validators/staking/staking-smart-contract](https://docs.multiversx.com/validators/staking/staking-smart-contract/); [docs.multiversx.com/validators/staking](https://docs.multiversx.com/validators/staking/).
...
See also: Staking Auction and TopUp, Soft Auction, Staking, Auction List.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/).
...
See also: Soft Auction, Top-up, Waiting List, Eligible Nodes.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/).
...
See also: Auction List, Eligible Nodes, Validator Reshuffle (Epoch Boundary), Soft Auction.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/); [docs.multiversx.com/learn/sharding](https://docs.multiversx.com/learn/sharding).
...
See also: Validator (node), Waiting List, Validator Reshuffle (Epoch Boundary), Consensus Group.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/).
...
See also: Auction List, Top-up, Waiting List, Staking Auction and TopUp.
Source: [docs.multiversx.com/validators/staking-v4](https://docs.multiversx.com/validators/staking-v4/).
...
See also: Jailing, Validator Rating, Staking, Secure Proof of Stake (SPoS).
Source: [docs.multiversx.com/validators/overview](https://docs.multiversx.com/validators/overview/).
...
See also: Key Pair (Public and Private Key), BLS Multi-Signature, Multikey Nodes, Slashing.
Source: [docs.multiversx.com/validators/key-management/validator-keys](https://docs.multiversx.com/validators/key-management/validator-keys/).
...
See also: Multikey Nodes, BLS Key (Validator Key), Slashing, Validator (node).
Source: [docs.multiversx.com/validators/redundancy](https://docs.multiversx.com/validators/redundancy/).
...
See also: BLS Key (Validator Key), Node Redundancy, Validator (node), Staking.
Source: [docs.multiversx.com/validators/key-management/multikey-nodes](https://docs.multiversx.com/validators/key-management/multikey-nodes/).
...
See also: Delegation Contract, Delegation Manager, Staking, Delegation.
Source: [docs.multiversx.com/validators/staking/merge-validator-delegation-sc](https://docs.multiversx.com/validators/staking/merge-validator-delegation-sc/).
...
See also: Delegation Contract, Staking provider, Delegation, System Smart Contracts.
Source: [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Delegation Manager, Staking provider, Delegation cap, Service Fee.
Source: [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Elastic Indexer, Observer (node), Deep-History Squad.
Source: [docs.multiversx.com/validators/import-db](https://docs.multiversx.com/validators/import-db/).
...
See also: xPortal, Key Pair, Onchain Guardian, NativeAuth.
Source: [docs.multiversx.com/wallet/web-wallet](https://docs.multiversx.com/wallet/web-wallet/).
...
See also: Wallet, Herotag, EGLD, ESDT.
Source: [multiversx.com/ecosystem/project/xportal](https://multiversx.com/ecosystem/project/xportal); MultiversX Help Center.
...
See also: Bech32 Addressing, Mnemonic, Message Signing, Onchain Guardian.
Source: [docs.multiversx.com/wallet/wallets](https://docs.multiversx.com/wallet/wallets/); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Key Pair, Keystore and PEM, Onchain Guardian.
Source: [docs.multiversx.com/wallet/wallets](https://docs.multiversx.com/wallet/wallets/); [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core).
...
See also: Key Pair, Mnemonic, Wallet.
Source: [docs.multiversx.com/sdk-and-tools/sdk-py](https://docs.multiversx.com/sdk-and-tools/sdk-py/); [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core).
...
See also: NativeAuth, Key Pair, Bech32 Addressing.
Source: [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core); [docs.multiversx.com/sdk-and-tools/sdk-js](https://docs.multiversx.com/sdk-and-tools/sdk-js/).
...
See also: Wallet, Wallet Extension (DeFi Wallet), xAlias, Keystore and PEM.
Source: [docs.multiversx.com/wallet/web-wallet](https://docs.multiversx.com/wallet/web-wallet/).
...
See also: Wallet, Web Wallet, Mnemonic (Seed Phrase), mx-sdk-dapp.
Source: [docs.multiversx.com/wallet/wallet-extension](https://docs.multiversx.com/wallet/wallet-extension/).
...
See also: Wallet, Web Wallet, Key Pair (Public and Private Key), Onchain Guardian.
Source: [docs.multiversx.com/wallet/ledger](https://docs.multiversx.com/wallet/ledger/).
...
See also: Wallet, Web Wallet, Mnemonic (Seed Phrase), NativeAuth.
Source: [docs.multiversx.com/wallet/xalias](https://docs.multiversx.com/wallet/xalias/).
...
See also: xPortal, Wallet, mx-sdk-dapp, Message Signing.
Source: [docs.multiversx.com/integrators/walletconnect-json-rpc-methods](https://docs.multiversx.com/integrators/walletconnect-json-rpc-methods/); [docs.multiversx.com/wallet/xportal](https://docs.multiversx.com/wallet/xportal/).
...
See also: WEGLD, ESDT, EGLD, Liquid Staking.
Source: [multiversx.com/ecosystem](https://multiversx.com/ecosystem); [xexchange.com](https://xexchange.com).
...
See also: xPortal, EGLD, ESDT.
Source: [multiversx.com/ecosystem](https://multiversx.com/ecosystem).
...
See also: Governance Proposal Process, Barnard.
Source: MultiversX State of the Foundation Report 2025 ([files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf](https://files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf)).
...
See also: Secure Proof of Stake, ScenarioWorld.
Source: MultiversX State of the Foundation Report 2025 ([files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf](https://files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf)).
...
See also: Relayed Transactions, ESDT.
Source: MultiversX State of the Foundation Report 2025 ([files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf](https://files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf)).
...
See also: Secure Proof of Stake, Supernova.
Source: MultiversX, "Andromeda" release post ([multiversx.com/blog/andromeda-supernova-highspeed-highways](https://multiversx.com/blog/andromeda-supernova-highspeed-highways)); State of the Foundation Report 2025.
...
See also: Governance Proposal Process, Supernova.
Source: MultiversX State of the Foundation Report 2025 ([files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf](https://files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf)).
...
See also: Staking V5, KPI-Gated Emissions, EGLD, Developer Revenue Share, Governance Proposal Process.
Source: MultiversX, "The MultiversX Economic Evolution" (Oct 22, 2025, [multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion](https://multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion)); economic framework proposal on Agora ([agora.multiversx.com/t/...530](https://agora.multiversx.com/t/a-competitive-economic-framework-for-multiversx-toward-revenue-and-reflexive-value-accrual/530)).
...
See also: Cross-Shard Atomicity, Hyperblock, Andromeda, Secure Proof of Stake.
Source: MultiversX, "Supernova: decoupling consensus and execution" ([multiversx.com/blog/supernova-decoupling-consensus-and-execution](https://multiversx.com/blog/supernova-decoupling-consensus-and-execution)); test figures from xAlliance Substack, "Supernova Engine Room" series and [@MultiversX, March 31, 2026](https://x.com/MultiversX/status/2039002331640180765).
...
See also: Tx Syntax, Typed Proxies, sc-meta, WASM VM.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/base/src/storage/mappers/`); MultiversX docs, storage mappers ([docs.multiversx.com/developers/developer-reference/storage-mappers](https://docs.multiversx.com/developers/developer-reference/storage-mappers/)).
...
See also: Typed Proxies, Storage Mappers, Cross-Shard Atomicity.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/base/src/types/interaction/tx.rs`); [docs.multiversx.com/sdk-and-tools/sdk-rust](https://docs.multiversx.com/sdk-and-tools/sdk-rust/).
...
See also: Tx Syntax, sc-meta, ScenarioWorld.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/meta-lib`); Andrei Marinica, "One Syntax to rule them all," Part 2 (2024).
...
See also: Typed Proxies, sc-meta, Vega.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/scenario`); [docs.multiversx.com/developers/testing/rust/sc-test-overview](https://docs.multiversx.com/developers/testing/rust/sc-test-overview/).
...
See also: Typed Proxies, ScenarioWorld, WASM VM, Storage Mappers.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/meta`); [docs.multiversx.com/developers/meta/sc-meta](https://docs.multiversx.com/developers/meta/sc-meta/).
...
See also: Onchain Guardian, Bech32 Addressing.
Source: [github.com/multiversx/mx-sdk-dapp](https://github.com/multiversx/mx-sdk-dapp) (`src/services/nativeAuth/`); `@multiversx/sdk-native-auth-client` and `@multiversx/sdk-native-auth-server` packages.
...
See also: Typed Proxies, Tx Syntax, sc-meta.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs); [docs.multiversx.com/developers/data/abi](https://docs.multiversx.com/developers/data/abi/).
...
See also: WASM VM, Storage Mappers, Tx Syntax.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/base/src/types`); [docs.multiversx.com/developers/developer-reference](https://docs.multiversx.com/developers/developer-reference/).
...
See also: sc-meta, Typed Proxies, Account Nonce.
Source: [docs.multiversx.com/sdk-and-tools/mxpy](https://docs.multiversx.com/sdk-and-tools/mxpy/).
...
See also: Bech32 Addressing, Relayed Transactions, mxpy.
Source: [docs.multiversx.com/developers/account-management](https://docs.multiversx.com/developers/account-management/); [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core).
...
See also: Storage Mappers, Tx Syntax, Typed Proxies, sc-meta, Managed Types.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs); [docs.multiversx.com/sdk-and-tools/overview](https://docs.multiversx.com/sdk-and-tools/overview/).
...
See also: mx-sdk-dapp, Account Nonce, NativeAuth.
Source: [github.com/multiversx/mx-sdk-js-core](https://github.com/multiversx/mx-sdk-js-core); [docs.multiversx.com/sdk-and-tools/sdk-js](https://docs.multiversx.com/sdk-and-tools/sdk-js/).
...
See also: mx-sdk-js-core, NativeAuth, Wallet.
Source: [github.com/multiversx/mx-sdk-dapp](https://github.com/multiversx/mx-sdk-dapp); [docs.multiversx.com/sdk-and-tools/sdk-dapp](https://docs.multiversx.com/sdk-and-tools/sdk-dapp/).
...
See also: ScenarioWorld, sc-meta, Chain Simulator.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs); [docs.multiversx.com/developers/testing/rust/sc-test-overview](https://docs.multiversx.com/developers/testing/rust/sc-test-overview/).
...
See also: ScenarioWorld, MultiversX Proxy, Vega.
Source: [docs.multiversx.com/sdk-and-tools/chain-simulator](https://docs.multiversx.com/sdk-and-tools/chain-simulator/).
...
See also: Observing Squad, MultiversX API, Observer.
Source: [docs.multiversx.com/sdk-and-tools/overview](https://docs.multiversx.com/sdk-and-tools/overview/); [docs.multiversx.com/integrators/observing-squad](https://docs.multiversx.com/integrators/observing-squad/).
...
See also: MultiversX Proxy, Observing Squad, NativeAuth.
Source: [docs.multiversx.com/sdk-and-tools/rest-api](https://docs.multiversx.com/sdk-and-tools/rest-api/).
...
See also: multiversx-sc (mx-sdk-rs), Storage Mappers, Reusable Modules, ABI, sc-meta.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/derive`); [docs.multiversx.com/developers/developer-reference](https://docs.multiversx.com/developers/developer-reference/).
...
See also: multiversx-sc (mx-sdk-rs), Contract Trait (#[contract], #[module]), Storage Mappers, Tx Syntax.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`contracts/modules`); [docs.multiversx.com/developers/developer-reference](https://docs.multiversx.com/developers/developer-reference/).
...
See also: multiversx-sc (mx-sdk-rs), Managed Types, ABI.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/base/src/types`); [docs.multiversx.com/developers/developer-reference](https://docs.multiversx.com/developers/developer-reference/).
...
See also: Typed Proxies, ScenarioWorld, Chain Simulator, sc-meta.
Source: [github.com/multiversx/mx-sdk-rs](https://github.com/multiversx/mx-sdk-rs) (`framework/snippets`); [docs.multiversx.com/sdk-and-tools/sdk-rust](https://docs.multiversx.com/sdk-and-tools/sdk-rust/).
...
See also: mx-sdk-js-core, mx-sdk-dapp, sdk-py, sdk-nestjs, mxpy.
Source: [docs.multiversx.com/sdk-and-tools/overview](https://docs.multiversx.com/sdk-and-tools/overview/).
...
See also: Official SDKs, mxpy, mx-sdk-js-core.
Source: [docs.multiversx.com/sdk-and-tools/sdk-py](https://docs.multiversx.com/sdk-and-tools/sdk-py/).
...
See also: Official SDKs, NativeAuth, mx-sdk-js-core.
Source: [docs.multiversx.com/sdk-and-tools/sdk-nestjs](https://docs.multiversx.com/sdk-and-tools/sdk-nestjs/).
...
See also: View, Contract Trait (#[contract], #[module]), ABI (Application Binary Interface), Payable Endpoint.
Source: [docs.multiversx.com/developers/developer-reference/sc-annotations](https://docs.multiversx.com/developers/developer-reference/sc-annotations/).
...
See also: Endpoint, ABI (Application Binary Interface), Contract Trait (#[contract], #[module]).
Source: [docs.multiversx.com/developers/developer-reference/sc-annotations](https://docs.multiversx.com/developers/developer-reference/sc-annotations/).
...
See also: Endpoint, Code Metadata, ESDT (eStandard Digital Token), Tx Syntax.
Source: [docs.multiversx.com/developers/developer-reference/sc-payments](https://docs.multiversx.com/developers/developer-reference/sc-payments/).
...
See also: Endpoint, Contract Trait (#[contract], #[module]), Reusable Modules (multiversx-sc-modules).
Source: [docs.multiversx.com/developers/developer-reference/sc-annotations](https://docs.multiversx.com/developers/developer-reference/sc-annotations/).
...
See also: Callback, Tx Syntax, Cross-Shard Atomicity, Typed Proxies.
Source: [docs.multiversx.com/developers/developer-reference/sc-to-sc-calls](https://docs.multiversx.com/developers/developer-reference/sc-to-sc-calls/).
...
See also: Contract Calls (sync, async, transfer-execute), Cross-Shard Atomicity, Tx Syntax.
Source: [docs.multiversx.com/developers/developer-reference/sc-to-sc-calls](https://docs.multiversx.com/developers/developer-reference/sc-to-sc-calls/).
...
See also: Init and Upgrade, Payable Endpoint, Contract Trait (#[contract], #[module]).
Source: [docs.multiversx.com/developers/data/code-metadata](https://docs.multiversx.com/developers/data/code-metadata/).
...
See also: ABI (Application Binary Interface), Managed Types, Multi-Value Types.
Source: [docs.multiversx.com/developers/data/serialization-overview](https://docs.multiversx.com/developers/data/serialization-overview/).
...
See also: Managed Types, Contract Trait (#[contract], #[module]).
Source: [docs.multiversx.com/developers/best-practices/managed-decimal](https://docs.multiversx.com/developers/best-practices/managed-decimal/).
...
See also: Gas and Fees, Gas Price, Gas Refund.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Gas and Fees, Gas Limit, Gas-Price Modifier.
Source: [docs.multiversx.com/developers/gas-and-fees/overview](https://docs.multiversx.com/developers/gas-and-fees/overview/).
...
See also: Reproducible Build, Smart Contract, Contract Address.
Source: [docs.multiversx.com/developers/reproducible-contract-builds](https://docs.multiversx.com/developers/reproducible-contract-builds/).
...
See also: Code Hash, sc-meta, Smart Contract.
Source: [docs.multiversx.com/developers/reproducible-contract-builds](https://docs.multiversx.com/developers/reproducible-contract-builds/).
...
See also: Account, Bech32 Addressing (erd1…), Account Nonce, Smart Contract.
Source: [docs.multiversx.com/developers/smart-contracts](https://docs.multiversx.com/developers/smart-contracts/).
...
See also: ScenarioWorld, Scenarios (testing), Typed Proxies, sc-meta.
Source: [docs.multiversx.com/developers/testing/testing-overview](https://docs.multiversx.com/developers/testing/testing-overview/).
...
See also: MultiversX Proxy, Observing Squad, MultiversX API.
Source: [docs.multiversx.com/sdk-and-tools/rest-api/gateway-overview](https://docs.multiversx.com/sdk-and-tools/rest-api/gateway-overview/).
...
See also: MultiversX API, Observer (node), Events Notifier.
Source: [docs.multiversx.com/sdk-and-tools/elastic-indexer](https://docs.multiversx.com/sdk-and-tools/elastic-indexer/).
...
See also: Elastic Indexer, MultiversX API, Observer (node).
Source: [docs.multiversx.com/sdk-and-tools/notifier](https://docs.multiversx.com/sdk-and-tools/notifier/).
...
See also: Observing Squad, Snapshotless Observer, MultiversX Proxy.
Source: [docs.multiversx.com/integrators/deep-history-squad](https://docs.multiversx.com/integrators/deep-history-squad/).
...
See also: Observer (node), Deep-History Squad, Observing Squad.
Source: [docs.multiversx.com/integrators/snapshotless-observing-squad](https://docs.multiversx.com/integrators/snapshotless-observing-squad/).
...
See also: MCP Server, MPP, Agent Hub, x402.
Source: MultiversX, "Universal Identity and Trust Layer for Agents" ([multiversx.com/blog/universal-identity-and-trust-layer-for-agents](https://multiversx.com/blog/universal-identity-and-trust-layer-for-agents)).
...
See also: Agent Hub, MX-8004, x402.
Source: [github.com/multiversx/mx-mcp](https://github.com/multiversx/mx-mcp); MultiversX `/ai` page ([multiversx.com/ai](https://multiversx.com/ai)); tool and skill counts corroborated by internal review (May 2026).
...
See also: MPP, Agent Hub, MCP Server, MX-8004.
Source: MultiversX, "MultiversX speaks Agent" ([multiversx.com/blog/multiversx-speaks-agent](https://multiversx.com/blog/multiversx-speaks-agent)); x402 protocol specification (external).
...
See also: x402, Supernova, Agent Hub, MX-8004.
Source: MultiversX, "Stripe's Machine Payments Protocol on MultiversX" ([multiversx.com/blog/stripes-machine-payments-protocol-on-multiversx](https://multiversx.com/blog/stripes-machine-payments-protocol-on-multiversx)).
...
See also: MX-8004, MCP Server, x402, MPP.
Source: MultiversX, "The MultiversX Universal Agentic Commerce Stack" ([multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack](https://multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack)).
...
See also: AP2, ACP, x402 (MultiversX adapter), Agent Hub.
Source: Google Developers Blog, "Under the hood: Universal Commerce Protocol (UCP)"; Shopify Engineering, "UCP"; MultiversX agentic-stack coverage ([multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack](https://multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack)).
...
See also: UCP, ACP, x402 (MultiversX adapter), MX-8004, Agent Hub.
Source: Google Cloud Blog, "Announcing the Agent Payments Protocol (AP2)"; MultiversX agentic-stack coverage ([multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack](https://multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack)).
...
See also: UCP, AP2, MPP, x402 (MultiversX adapter), Agent Hub.
Source: Stripe newsroom, "Stripe and OpenAI bring Instant Checkout to ChatGPT" (Sept 2025); MultiversX agentic-stack coverage ([multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack](https://multiversx.com/blog/the-multiversx-universal-agentic-commerce-stack)).
...
See also: MCP Server (MultiversX), mx-ai-skills, Agent Hub, mx-sdk-js-core.
Source: MultiversX `/ai` page ([multiversx.com/ai](https://multiversx.com/ai)); MultiversX agentic-stack coverage. (Provenance: confirm whether the kit is hosted under the `multiversx` org or a core engineer's personal account before publishing a direct link.)
...
See also: MCP Server (MultiversX), mx-agent-kit, Agent Hub.
Source: MultiversX `/ai` page ([multiversx.com/ai](https://multiversx.com/ai)); skill count corroborated by internal review (May 2026).
...
See also: MX-8004, MX-8004 Sub-Contracts, Agent Hub, MCP Server (MultiversX).
Source: MultiversX `/ai` page ([multiversx.com/ai](https://multiversx.com/ai)); Agent Explorer ([agents.multiversx.com](https://agents.multiversx.com)), a devnet preview verified by internal review (2026).
...
See also: Agent Hub, MX-8004, Agent Explorer.
...
See also: MX-8004, Agent Explorer, Agent Hub, Herotag.
Source: MultiversX, "Universal Identity and Trust Layer for Agents" ([multiversx.com/blog/universal-identity-and-trust-layer-for-agents](https://multiversx.com/blog/universal-identity-and-trust-layer-for-agents)); ERC-8004 comparison and ratification status corroborated by internal review (May 2026).
...
See also: Economic Evolution, Staking V5, KPI-Gated Emissions, EGLD.
Source (live, 30%): [docs.multiversx.com/developers/built-in-functions](https://docs.multiversx.com/developers/built-in-functions/) (ClaimDeveloperRewards). Source (proposed, 90%): "A competitive economic framework for MultiversX: toward revenue and reflexive value accrual," MultiversX Agora ([agora.multiversx.com/t/...530](https://agora.multiversx.com/t/a-competitive-economic-framework-for-multiversx-toward-revenue-and-reflexive-value-accrual/530)).
...
See also: Economic Evolution, Supernova, Barnard, Sirius.
Source: [docs.multiversx.com/governance/overview](https://docs.multiversx.com/governance/overview/); MultiversX State of the Foundation Report 2025 ([files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf](https://files.multiversx.com/MultiversX-State-of-the-Foundation-Report-2025.pdf)).
...
See also: Economic Evolution, KPI-Gated Emissions, EGLD, Fee Burn.
Source: MultiversX, "The MultiversX Economic Evolution" ([multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion](https://multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion)); economic framework proposal on Agora ([agora.multiversx.com/t/...530](https://agora.multiversx.com/t/a-competitive-economic-framework-for-multiversx-toward-revenue-and-reflexive-value-accrual/530)).
...
See also: Developer Revenue Share, Economic Evolution, Tail Inflation, Gas and Fees.
Source: economic framework proposal on Agora ([agora.multiversx.com/t/...530](https://agora.multiversx.com/t/a-competitive-economic-framework-for-multiversx-toward-revenue-and-reflexive-value-accrual/530)); MultiversX, "The MultiversX Economic Evolution" ([multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion](https://multiversx.com/blog/the-multiversx-economic-evolution-a-blueprint-for-growth-and-strategic-expansion)).
...
See also: Staking, Delegation, Service Fee, Staking Auction and TopUp.
Source: [docs.multiversx.com/economics/staking-providers-apr](https://docs.multiversx.com/economics/staking-providers-apr/); [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/).
...
See also: Delegation, Staking, APR.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Governance Proposal Process, Quorum, Veto, Voting Power.
Source: [docs.multiversx.com/governance/overview](https://docs.multiversx.com/governance/overview/).
...
See also: Governance Proposal, Voting Power, Veto, Governance Proposal Process.
Source: [docs.multiversx.com/governance/overview](https://docs.multiversx.com/governance/overview/).
...
See also: Governance Proposal, Quorum, Voting Power, Governance Proposal Process.
Source: [docs.multiversx.com/governance/overview](https://docs.multiversx.com/governance/overview/).
...
See also: Governance Proposal, Quorum, Veto, Staking.
Source: [docs.multiversx.com/governance/overview](https://docs.multiversx.com/governance/overview/).
...
See also: Validator (node), Staking, Delegate, Secure Proof of Stake (SPoS).
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/overview](https://docs.multiversx.com/validators/overview/).
...
See also: Staking, Delegate, Stake rewards, Unstake.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Delegation, Stake, Delegate rewards, Service Fee.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Stake, APR (Annual Percentage Rate), Delegate rewards, Staking.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/economics/staking-providers-apr](https://docs.multiversx.com/economics/staking-providers-apr/).
...
See also: Delegate, Delegation, Service Fee, Stake rewards.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/economics/staking-providers-apr](https://docs.multiversx.com/economics/staking-providers-apr/).
...
See also: Unbond, Unbonding Period, Stake, Delegation.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/staking](https://docs.multiversx.com/validators/staking/).
...
See also: Staking pool, Delegation Contract, Delegate, Service Fee.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Staking provider, Delegation Contract, Delegation cap, System Smart Contracts.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
...
See also: Staking pool, Delegation Contract, Delegate, Staking provider.
Source: [docs.multiversx.com/welcome/terminology](https://docs.multiversx.com/welcome/terminology/); [docs.multiversx.com/validators/delegation-manager](https://docs.multiversx.com/validators/delegation-manager/).
