	...
	return (
		<footer className="footer d-flex flex-column align-items-center justify-content-center text-muted">
			<div className="footer-inner">
				<a href="/" className="d-flex align-items-center footer-text">
					...
					<svg aria-hidden="true" 
						 ...
						 data-prefix="fas" 
						 data-icon="heart" 
						 class="svg-inline--fa fa-heart fa-w-16 text-danger mx-1"
						 role="img" 
			...
			<div id="app-switcher-dropdown">
				<div className="switcher-icon" type="button">
					<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-labeledby="Menu">
