...
Ok, let's get started with the microservice. First, we'll clone the template provided by the MultiversX (previously Elrond) team.
...
Break down this guide and learn more about how to extend the microservice, the dapp and the smart contract. Learn more on the MultiversX (previously Elrond) official documentation site here: [https://docs.multiversx.com](/).
