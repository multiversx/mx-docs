...
description: A working Next.js 15 App Router starter with sdk-dapp v5. Client-only init wrapper, the real next.config.js, login button, account hook, compiles strict.
difficulty: beginner
est_minutes: 10
artifact: project
sdk_versions:
...
This recipe gives you the smallest working sdk-dapp v5 setup in a Next.js 15 App
