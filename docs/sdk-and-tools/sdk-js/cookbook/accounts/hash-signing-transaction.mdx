...
set, and sign it correctly by signing the transaction *hash*. Along the way this
recipe demonstrates a real v15.4.1 trap: `Account.signTransaction` does **not**
...
cd cookbook/recipes/hash-signing-transaction
npm install
npm run build
npm start
```
