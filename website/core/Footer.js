...
export default function CustomFooter() {
	...
	return (
		<footer className="footer d-flex flex-column align-items-center justify-content-center text-muted">
			...
			<div id="app-links">
				<a href="https://github.com/ElrondNetwork" target="_blank" rel="noopener noreferrer" className="app-menu-entry d-flex align-items-center">
					<svg className="app-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path id="Path" class="st0" fillRule="evenodd" clipRule="evenodd" d="M12,0C5.4,0,0,5.4,0,12c0,5.3,3.4,9.8,8.2,11.4C8.8,23.5,9,23.1,9,22.8c0-0.3,0-1.2,0-2.2
								...
								c0.4,0.4,0.8,1.1,0.8,2.2c0,1.6,0,2.9,0,3.3c0,0.3,0.2,0.7,0.8,0.6C20.6,21.8,24,17.3,24,12C24,5.4,18.6,0,12,0z"></path>

					</svg>
					<span className="pl-1 menu-text">Github</span>
				</a>
				<a href="https://t.me/ElrondNetwork" target="_blank" rel="noopener noreferrer" className="app-menu-entry d-flex align-items-center">
					<svg className="app-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 19">
						<path fill-rule="evenodd" d="M.461 8.894l4.9 1.829 1.897 6.1c.121.39.6.535.917.275l2.73-2.226a.815.815 0 0 1 .994-.028l4.927 3.577c.34.247.82.06.905-.35L21.34.712a.578.578 0 0 0-.774-.656L.456 7.813a.578.578 0 0 0 .005 1.08zm6.492.855l9.577-5.898c.172-.106.349.127.201.264l-7.904 7.347a1.64 1.64 0 0 0-.508.98l-.269 1.995c-.035.267-.41.293-.483.036L6.53 10.834a.964.964 0 0 1 .422-1.085z"></path>
					</svg>
