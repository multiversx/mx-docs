...
- `67656e65736973` is the aforementioned result of signing the address of the sender of the transaction, repeated;
...
- `45e7131ba....294812f004` is the BLS key of the first node, represented as a 192-character-long hexadecimal string;
- `ecf6fdbf5....70f1d251f7` is the BLS key of the second node, represented as a 192-character-long hexadecimal string;
- the result of signing the address of the sender of the transaction is not needed, as opposed to the staking transaction (see above)
